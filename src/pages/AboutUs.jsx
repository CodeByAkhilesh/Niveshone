    ...
    <>
      ...
      <main>
        <section className="min-h-screen w-full md:pt-35 md:pb-25 xl:w-302.5 mx-auto lg:px-10 flex flex-col lg:flex-row md:justify-between">
          ...
          {/* Founder Image  */}
          <figure className="left-content h-140 w-80 relative md:shrink-0 mx-auto mt-10 md:mt-0">
          ...
          <article className="right-content px-10 h-140 md:w-190 lg:w-165 shrink-0 text-white flex items-center mx-auto">
            <div className="md:pl-10 w-full">
              ...
              <p className="md:text-[22px] leading-tight pt-5">
                <b> Nivesh One Finance Services </b> is a client-centric
                financial services brand committed to helping individuals
                achieve their financial goals through disciplined and goal-based
                mutual fund investing. We believe that successful investing is
                built on consistency, proper asset allocation, and a clear
                long-term approach rather than short-term market movements.
              </p>
              <p className="md:text-[22px] leading-tight pt-6">
                Our focus is on understanding each client’s financial needs,
                risk profile, and investment horizon to provide suitable mutual
                fund solutions. With an emphasis on transparency, simplicity,
                and ethical practices, we aim to build long-term relationships
                and support investors in their wealth creation journey.
              </p>
            </div>
          </article>
        </section>
