...
const [goalsData, setGoalsData] = useState([
  ...
  return (
    <div>
      ...
      <div className='py-10 md:py-15 xl:py-5 flex flex-col md:flex-row flex-wrap gap-y-15 md:px-10 xl:px-15  items-center md:justify-between md:w-193.75 xl:w-302.5 mx-auto'>
            {goalsData.map((data, index)=>{
              return(
                <GoalsCard key={index} goalsData={data}/>
              )
