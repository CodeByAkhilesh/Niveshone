...
const AboutUs = () => {
  return (
    <div className="w-full">
      <Navbar />
      <div className="min-h-screen  pt-35 pb-25 w-302.5 mx-auto px-10 flex  justify-between">
        <div className="left-content h-140 w-85 relative shrink-0">
        ...
        <div className="right-content h-140 w-190 shrink-0 text-white flex items-center">
          <div className="pl-10 w-full">
            <h3 className="text-4xl  xl:w-302.5 font-bold text-whitentracking-tighter pb-10">
              Meet{" "}
              <span className="bg-linear-to-r from-[#3aab50] to-[#268eff] bg-clip-text text-transparent">
                The Founder
              </span>
            </h3>
            <h1 className="text-6xl font-bold leading-8">
              Akhilesh R Yadav <br />{" "}
              <span className="text-2xl font-bold text-[#3aab50]">
                250,000+ Youtube | 150,000+ Instagram
              </span>
            </h1>
            <p className="text-2xl leading-tight pt-5">
            ...
            <p className="text-2xl leading-tight pt-6">
