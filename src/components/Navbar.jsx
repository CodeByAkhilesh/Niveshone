  ...
  return (
    <nav className="text-white md:max-w-[1210px] mx-auto md:px-10 lg:px-5 px-10 py-4 flex justify-between items-center">
      ...
      <div className="text-2xl font-bold w-20">
        <img className="object-cover h-full w-full " src="src\assets\brand-logo-web.png" alt="Logo" />
      </div>

      {/* Desktop Menu */}
      <ul className="hidden md:flex gap-8 text-lg items-center">
        <li className="cursor-pointer hover:text-blue-400 font-bold">Home</li>
        <li className="cursor-pointer hover:text-blue-400 font-bold">Services</li>
        <li className="cursor-pointer hover:text-blue-400 font-bold">About</li>
        <li className="cursor-pointer hover:text-blue-400 font-bold">Calculator</li>
        <li className="cursor-pointer hover:text-blue-400 font-bold">Contact</li>
      ...
      {/* Mobile Menu */}
      {open && (
        <ul className="absolute top-16 left-0 w-full bg-gray-800 flex flex-col gap-4 py-6 text-center md:hidden text-lg">
